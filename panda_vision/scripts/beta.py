...
def pcd_maker():
    pcd = o3d.io.read_point_cloud("/home/rnm/Desktop/11/new/1657020870486735.pcd" )           #("/home/rnm/Desktop/pcd_data/1590496721.382030864.pcd" )  
    ...
    pcd = o3d.io.read_point_cloud("/home/rnm/Desktop/11/new/cropped_1.ply")     #("/home/rnm/catkin_ws/src/panda_vision/scripts/cropped_03.ply")
...
def execute_fast_global_registration(source_down, target_down, source_fpfh,
    ...
    distance_threshold = voxel_size * 400
    ...
    result = o3d.pipelines.registration.registration_ransac_based_on_feature_matching(
        ...
        3, [
            ...
            o3d.pipelines.registration.CorrespondenceCheckerBasedOnDistance(
                distance_threshold)
        ], o3d.pipelines.registration.RANSACConvergenceCriteria(800000, 0.999))
    return result
